export const CATEGORY_MAPPING: Record<string, string[]> = {
    ...
    Équipements: [
        'Anneau', 'Chapeau', 'Ceinture', 'Cape', 'Amulette', 'Bottes', 'Bouclier', 'Épée', 'Dague', 'Hache', 'Bâton', 'Marteau', 'Baguette', 'Pelle', 'Faux', 'Lance', 'Arc', 'Pioche', 'Outil'
    ],
    Forgemages: [
        'Gravure de forgemagie', 'Rune astrale', 'Potion de forgemagie', 'Rune de transcendance', 'Rune de forgemagie'
    ],
    Créatures: [
        'Objet d\'élevage'
    ],
    ...
    Cosmétiques: [
        'Bouclier d\'apparat', 'Cape d\'apparat', 'Chapeau d\'apparat'
    ]
};
